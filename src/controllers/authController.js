...
exports.signup = async (req, res) => {
  ...
  const  {access_token,class_id,phone_number,profile_image,refresh_token,role,studentDOB,studentGender,student_name,studentboard_id  }= req.body; // Get role from request body
